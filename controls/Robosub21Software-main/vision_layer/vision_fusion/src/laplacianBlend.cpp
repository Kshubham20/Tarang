...
void LaplacianBlending::buildGaussianPyramid() {
    ...
    cvtColor(leftMask, currLeftImg, cv::COLOR_GRAY2BGR);
    cvtColor(rightMask, currRightImg, cv::COLOR_GRAY2BGR);
    ...
    for (int l = 1; l < levels+1; l++) {
        ...
        Mat downRight;
        Mat downLeft;
        cvtColor(_downLeft, downLeft, cv::COLOR_GRAY2BGR);
        cvtColor(_downRight, downRight, cv::COLOR_GRAY2BGR);
